...
/**
 * GitHub's Octocat mark, inlined. lucide dropped its brand icons, and a single path is
 * cheaper than a dependency — the same call `google-button.tsx` makes for Google's.
 */
