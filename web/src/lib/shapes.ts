...
export const SHAPE_LIST: ShapeDef[] = [
  { key: "rect", label: "矩形", viewBox: 200, preset: "rect", path: "M 0 0 L 200 0 L 200 200 L 0 200 Z" },
  {
    key: "roundRect",
    label: "圆角矩形",
    viewBox: 200,
  ...
  { key: "triangle", label: "三角形", viewBox: 200, preset: "triangle", path: "M 100 0 L 200 200 L 0 200 Z" },
  {
    key: "rightTriangle",
    label: "直角三角形",
    viewBox: 200,
  ...
  { key: "diamond", label: "菱形", viewBox: 200, preset: "diamond", path: "M 100 0 L 200 100 L 100 200 L 0 100 Z" },
  {
    key: "parallelogram",
    label: "平行四边形",
    viewBox: 200,
